...
public abstract class CommandBaseMenu extends CommandBaseExt {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if(found) {
            sender.sendMessage(new TextComponentTranslation("commands.pipemaster.denied"));
            return;
        }

        if(args.length == 0 || found == false) {
            TextComponentTranslation tc = new TextComponentTranslation("commands.pipemaster.available");
