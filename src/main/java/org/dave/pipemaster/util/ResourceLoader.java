...
ResourceLoader loader = new ResourceLoader(new File(ConfigurationHandler.configDir, "types.d"), "assets/pipemaster/config/types.d/");
...
public class ResourceLoader {
    ...
    public Map<String, InputStream> getResources() {
        ...
        if(DEVELOPMENT) {
            File assetPath = new File(PipeMaster.class.getResource("/" + assetPathName).getFile());
            ...
            URL srcUrl = PipeMaster.class.getResource("/" + assetPathName);
