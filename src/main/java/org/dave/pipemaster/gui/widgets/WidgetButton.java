...
import org.dave.pipemaster.gui.GUIHelper;
...
public class WidgetButton extends Widget {
    ...
    public ResourceLocation backgroundTexture = new ResourceLocation("minecraft", "textures/riddlechest/stone.png");
    public TextureAtlasSprite atlasSprite;

    protected static final ResourceLocation BUTTON_TEXTURES = new ResourceLocation(PipeMaster.MODID, "textures/gui/tabicons.png");
