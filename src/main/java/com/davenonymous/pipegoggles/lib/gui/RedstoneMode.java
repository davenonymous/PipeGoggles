...
public enum RedstoneMode implements StringRepresentable {
	IGNORE_POWER(0, "ignore", Component.translatable("patternconverter.redstone_mode.ignore_power")),
	REQUIRE_POWER(1, "require", Component.translatable("patternconverter.redstone_mode.require_power")),
	STOP_ON_POWER(2, "stop", Component.translatable("patternconverter.redstone_mode.stop_on_power"));
