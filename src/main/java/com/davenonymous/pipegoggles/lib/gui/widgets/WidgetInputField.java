...
public class WidgetInputField extends WidgetWithValue<String> {
	...
	private final BiFunction<String, Integer, String> textFormatter = (p_195610_0_, p_195610_1_) -> {
		return p_195610_0_;
	};
	...
	public void draw(GuiGraphics pGuiGraphics, Screen screen) {
        ...
        if (this.isVisible()) {
            ...
            int i = this.goggleMode ? this.enabledColor : this.disabledColor;
	...
	public void setClampedCursorPosition(int pos) {
		this.cursorPosition = Math.clamp(pos, 0, this.value.length());
	}
	...
	/**
	 * returns the width of the textbox depending on if background drawing is goggleMode
	 */
	...
	public void setSelectionPos(int position) {
		...
		this.selectionEnd = Math.clamp(position, 0, i);
		if(this.fontRenderer != null) {
			...
			this.lineScrollOffset = Math.clamp(this.lineScrollOffset, 0, i);
		}
